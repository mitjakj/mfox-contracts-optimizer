...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_ETH_ankrETH;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_ETH_ankrETH_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.ankrETH  // token1Address
        ],
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.wbnb, addresses.weth]),  // earnedToToken0Path
        utils.solidityPack(["address", "address", "address", "address"], [addresses.the, addresses.wbnb, addresses.weth, addresses.ankrETH]),  // earnedToToken1Path
        utils.solidityPack(["address", "address", "address"], [addresses.weth, addresses.wbnb, addresses.the]),  // token0ToEarnedPath
        utils.solidityPack(["address","address", "address", "address"], [addresses.ankrETH, addresses.weth, addresses.wbnb, addresses.the]),  // token1ToEarnedPath
        9990
    ]
    // Set constants [END]
    // Set constants [END]
