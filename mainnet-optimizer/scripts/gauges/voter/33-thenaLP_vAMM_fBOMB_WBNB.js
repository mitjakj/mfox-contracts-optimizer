...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaLP_vAMM_fBOMB_WBNB;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaLP_vAMM_fBOMB_WBNB_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.fbomb, // token0Address
            addresses.wbnb  // token1Address
        ],
        true, // isAutoComp
        false, // isStable
        [{from: addresses.the, to: addresses.wbnb, stable: false}, {from: addresses.wbnb, to: addresses.fbomb, stable: false}],  // earnedToToken0Path
        [{from: addresses.the, to: addresses.wbnb, stable: false}],  // earnedToToken1Path
        [{from: addresses.fbomb, to: addresses.wbnb, stable: false}, {from: addresses.wbnb, to: addresses.the, stable: false}],  // token0ToEarnedPath
        [{from: addresses.wbnb, to: addresses.the, stable: false}],  // token1ToEarnedPath
        9990
    ]
