...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_aBNBx_WBNB;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_aBNBx_WBNB_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.bnbx, // token0Address
            addresses.wbnb  // token1Address
        ],
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address"], [addresses.the, addresses.bnbx]),  // earnedToToken0Path
        utils.solidityPack(["address", "address"], [addresses.the, addresses.wbnb]),  // earnedToToken1Path
        utils.solidityPack(["address", "address"], [addresses.bnbx, addresses.the]),  // token0ToEarnedPath
