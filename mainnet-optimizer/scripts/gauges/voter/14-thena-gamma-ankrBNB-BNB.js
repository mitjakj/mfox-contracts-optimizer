...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_ankrBNB_BNB;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_ankrBNB_BNB_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.ankrBNB, // token0Address
            addresses.wbnb  // token1Address
        ],
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.wbnb, addresses.ankrBNB]),  // earnedToToken0Path
        utils.solidityPack(["address", "address"], [addresses.the, addresses.wbnb]),  // earnedToToken1Path
        utils.solidityPack(["address", "address", "address"], [addresses.ankrBNB, addresses.wbnb, addresses.the]),  // token0ToEarnedPath
