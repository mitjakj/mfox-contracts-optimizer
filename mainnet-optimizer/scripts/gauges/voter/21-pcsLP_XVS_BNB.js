...
async function main() {
    ...
    const LP_TOKEN = addresses.pcsLP_XVS_BNB;
    const IS_LP = false;
    ...
    const strategyParams = [
        ...
        [
            ...
            addresses.xvs  // token1Address
        ],
        false,
        true,
        9,
        [addresses.cake, addresses.wbnb],  // earnedToToken0Path
        [addresses.cake, addresses.wbnb, addresses.xvs], // earnedToToken1Path
        9990
    ]
    // Set constants [END]
    // Set constants [END]
