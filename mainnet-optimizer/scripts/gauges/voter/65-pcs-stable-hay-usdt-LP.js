...
async function main() {
    ...
    const LP_TOKEN = addresses.pcsStableLP_HAY_USDT;
    const IS_LP = false;
    ...
    // Strategy parameters
    const STRATEGY_NAME = "Strategy_PCS_Stable";
    const strategyParams = [
        [
            ...
            deployer.address,
            addresses.pcsRouter,
            addresses.pcsStable_HAY_USDT_POOL,
        ],
        [
            addresses.wbnb, // wbnb
        ...
        false, // _useMetapool
        163, // pid
        [addresses.cake, addresses.usdt],  // earnedToToken0Path
        [], // earnedToToken1Path
