...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaLP_vAMM_USDT_FEAR;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaLP_vAMM_USDT_FEAR_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.fear  // token1Address
        ],
        true, // isAutoComp
        false, // isStable
        [{from: addresses.the, to: addresses.usdt, stable: false}],  // earnedToToken0Path
        [{from: addresses.the, to: addresses.usdt, stable: false}, {from: addresses.usdt, to: addresses.fear, stable: false}],  // earnedToToken1Path
        [{from: addresses.usdt, to: addresses.the, stable: false}],  // token0ToEarnedPath
        [{from: addresses.fear, to: addresses.usdt, stable: false}, {from: addresses.usdt, to: addresses.the, stable: false}],  // token1ToEarnedPath
        9990
    ]
