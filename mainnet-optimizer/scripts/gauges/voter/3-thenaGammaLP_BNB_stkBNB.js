...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_BNB_stkBNB;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_BNB_stkBNB_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.stkBNB  // token1Address
        ],
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address"], [addresses.the, addresses.wbnb]),  // earnedToToken0Path
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.wbnb, addresses.stkBNB]),  // earnedToToken1Path
        utils.solidityPack(["address", "address"], [addresses.wbnb, addresses.the]),  // token0ToEarnedPath
        utils.solidityPack(["address", "address", "address"], [addresses.stkBNB, addresses.wbnb, addresses.the]),  // token1ToEarnedPath
        9990
    ]
    // Set constants [END]
    // Set constants [END]
