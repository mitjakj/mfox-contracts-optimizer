...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaLP_vAMM_XCAD_BUSD;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaLP_vAMM_XCAD_BUSD_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.xcad, // token0Address
            addresses.busd  // token1Address
        ],
        true, // isAutoComp
        false, // isStable
        [{from: addresses.the, to: addresses.busd, stable: false}, {from: addresses.busd, to: addresses.xcad, stable: false}],  // earnedToToken0Path
        [{from: addresses.the, to: addresses.busd, stable: false}],  // earnedToToken1Path
        [{from: addresses.xcad, to: addresses.busd, stable: false}, {from: addresses.busd, to: addresses.the, stable: false}],  // token0ToEarnedPath
