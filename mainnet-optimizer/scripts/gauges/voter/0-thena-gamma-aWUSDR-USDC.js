...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_aWUSDR_USDC;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_aWUSDR_USDC_GAUGE,
            deployer.address,
        ...
        [
            ...
            addresses.wUSDR, // token0Address
            addresses.usdc  // token1Address
        ],
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address", "address", "address"], [addresses.the, addresses.usdt, addresses.usdc, addresses.wUSDR]),  // earnedToToken0Path
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.usdt, addresses.usdc]),  // earnedToToken1Path
        utils.solidityPack(["address", "address", "address", "address"], [addresses.wUSDR, addresses.usdc, addresses.usdt, addresses.the]),  // token0ToEarnedPath
        utils.solidityPack(["address","address", "address"], [addresses.usdc, addresses.usdt, addresses.the]),  // token1ToEarnedPath
        9990
    ]
    // Set constants [END]
    // Set constants [END]
