...
const pools = require("../../../../stage-pools.js");
...
async function main() {
    ...
    const GAUGE_ADDRESS = '0x16a22488426742CDe589BC1D299D55BfaF28093d'; // GAUGE.gauge; // This constant should not be changed !!!

    // Strategy parameters
    const STRATEGY_NAME = "Strategy_Syrup";
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.pcsFarmSyrupCSIX,
            deployer.address,
            addresses.pcsRouter,
        ],
        [
            ...
            addresses.csix,  // earnedAddress
            addresses.cake, // token0Address
            ethers.constants.AddressZero  // token1Address
        ],
        true,
        true,
        0,
        [addresses.csix, addresses.cake],  // earnedToToken0Path
        [], // earnedToToken1Path
        9990
    ]
    // Set constants [END]
