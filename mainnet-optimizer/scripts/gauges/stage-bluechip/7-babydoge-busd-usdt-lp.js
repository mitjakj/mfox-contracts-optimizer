...
async function main() {
    ...
    const LP_TOKEN = addresses.babydogeLP_busd_usdt;
    const IS_LP = false;
    ...
    // Strategy parameters
    const STRATEGY_NAME = "Strategy_Babydoge";
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.babydogeFarm_busd_usdt,
            deployer.address,
            addresses.babydogeRouter,
        ],
        [
            addresses.wbnb, // wbnb
            LP_TOKEN,       // wantAddress
            addresses.babydoge,  // earnedAddress
        ...
        true,
        0, // pid 
        [addresses.babydoge, addresses.wbnb, addresses.usdt],  // earnedToToken0Path
        [addresses.babydoge, addresses.wbnb, addresses.busd],  // earnedToToken1Path
        9990
    ]
    // Set constants [END]
    // Set constants [END]
