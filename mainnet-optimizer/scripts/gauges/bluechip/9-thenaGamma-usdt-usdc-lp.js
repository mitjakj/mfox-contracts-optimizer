...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_usdt_usdc;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaGauge_stable_usdt_usd,
            deployer.address,
        ...
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.wbnb, addresses.usdt]),  // earnedToToken0Path
        utils.solidityPack(["address", "address", "address", "address"], [addresses.the, addresses.wbnb, addresses.usdt, addresses.usdc]),  // earnedToToken1Path
        utils.solidityPack(["address", "address", "address"], [addresses.usdt, addresses.wbnb, addresses.the]),  // token0ToEarnedPath
