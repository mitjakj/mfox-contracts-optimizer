...
async function main() {
    ...
    const LP_TOKEN = addresses.thenaGammaLP_aUSDT_USDC;
    const IS_LP = true;
    ...
    const strategyParams = [
        [
            GAUGE_ADDRESS,
            addresses.thenaGammaLP_aUSDT_USDC_GAUGE,
            deployer.address,
        ...
        true, // isAutoComp
        true, // isStable
        utils.solidityPack(["address", "address"], [addresses.the, addresses.usdt]),  // earnedToToken0Path
        utils.solidityPack(["address", "address", "address"], [addresses.the, addresses.usdt, addresses.usdc]),  // earnedToToken1Path
        utils.solidityPack(["address", "address"], [addresses.usdt, addresses.the]),  // token0ToEarnedPath
