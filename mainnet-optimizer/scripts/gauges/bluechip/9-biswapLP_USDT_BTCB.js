...
async function main() {
    ...
    const LP_TOKEN = addresses.biswapLP_USDT_BTCB;
    const IS_LP = false;
    ...
    const strategyParams = [
        ...
        [
            ...
            addresses.btcb  // token1Address
        ],
        false,
        true,
        6,
        [addresses.bsw, addresses.usdt],  // earnedToToken0Path
        [addresses.bsw, addresses.usdt, addresses.btcb], // earnedToToken1Path
        9990
    ]
    // Set constants [END]
    // Set constants [END]
