...
async function main() {
    ...
    const MAINCHAIN_GAUGE = pools[IS_BLUECHIP ? 'BSC_BLUECHIP' : 'BSC_VOTER'].pool49;
    const LP_TOKEN = addresses.arxLP_ARX_WETH;
    ...
    const strategyParams = [
        ...
        [
            ...
            addresses.arx  // token1Address
        ],
        false,
        true,
        15,
        [addresses.arx, addresses.weth],  // earnedToToken0Path
        [], // earnedToToken1Path
